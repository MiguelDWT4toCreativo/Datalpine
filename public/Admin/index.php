    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                include "../../resources/db/consultasDB.php";
                $consultasDB = new consultasDB();
                
                // Estadisticas Hombres
                $H_0_19 = $consultasDB->getsumaHombre0_19();
                foreach ($H_0_19 as $h019) : ?>
                    <input type="hidden" class="sumaHombre0_19" id="sumaHombre0_19" value="<?= $h019['Hombres_0_19'] ?>">
                <?php
                endforeach;
                ?>

                <?php
                $H_20_34 = $consultasDB->getsumaHombre20_34();
                foreach ($H_20_34 as $h2034) : ?>
                    <input type="hidden" id="sumaHombre20_34" value="<?= $h2034['Hombres_20_34'] ?>">
                <?php
                endforeach;
                ?>

                <?php
                $H_35_49 = $consultasDB->getsumaHombre35_49();
                foreach ($H_35_49 as $h3549) : ?>
                    <input type="hidden" id="sumaHombre35_49" value="<?= $h3549['Hombres_35_49'] ?>">
                <?php
                endforeach;
                ?>

                <?php
                $H_50_64 = $consultasDB->getsumaHombre50_64();
                foreach ($H_50_64 as $h5064) : ?>
                    <input type="hidden" id="sumaHombre50_64" value="<?= $h5064['Hombres_50_64'] ?>">
                <?php
                endforeach;
                ?>

                <?php
                $H_65_mas = $consultasDB->getsumaHombre65_y_mas();
                foreach ($H_65_mas as $h65mas) : ?>
                    <input type="hidden" id="sumaHombre65_y_mas" value="<?= $h65mas['Hombres_65_mas'] ?>">
                <?php
                endforeach;
                ?>
                ...
                <?php
                $M_0_19 = $consultasDB->getsumaMujer0_19();
                foreach ($M_0_19 as $m019) : ?>
                    <input type="hidden" id="sumaMujer0_19" value="<?= $m019['Mujeres_0_19'] ?>">
                <?php
                endforeach;
                ?>

                <?php
                $M_20_34 = $consultasDB->getsumaMujer20_34();
                foreach ($M_20_34 as $m2034):?>
                    <input type="hidden" id="sumaMujer20_34" value="<?= $m2034['Mujeres_20_34']?>">
                <?php
                endforeach;
                ?>

                <?php
                $M_35_49 = $consultasDB->getsumaMujer35_49();
                foreach ($M_35_49 as $m3549) : ?>
                    <input type="hidden" id="sumaMujer35_49" value="<?= $m3549['Mujeres_35_49']?>">
                <?php
                endforeach;
                ?>

                <?php
                $M_50_64 = $consultasDB->getsumaMujer50_64();
                foreach ($M_50_64 as $m5064) : ?>
                    <input type="hidden" id="sumaMujer50_64" value="<?= $m5064['Mujeres_50_64'] ?>">
                <?php
                endforeach;
                ?>

                <?php
                $M_65_mas = $consultasDB->getsumaMujer65_y_mas();
                foreach ($M_65_mas as $m65mas) : ?>
                    <input type="hidden" id="sumaMujer65_y_mas" value="<?= $m65mas['Mujeres_65_mas'] ?>">
                <?php
                endforeach;
                ?>
                ...
                <div class="row">
                    <div class="col-xl-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap align-items-center mb-4">
                                    <h5 class="card-title me-2">Graficas de Investigacion del Mercado</h5>
                                </div>
                                        ...
                                        <div class="p-4">
                                            <div class="mt-0">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <span class="font-size-16">Hombres</span>
                                                    </div>

                                                    <div class="flex-shrink-0">
                                                        <span class="badge rounded-pill bg-success-subtle text-success fw-medium"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <span class="font-size-16">Mujeres</span>
                                                    </div>
