                    ...
                    <div
                        ...
                        <div style="text-align: left;">
                            <p style="font-size: 16px; font-family: 'Arial', sans-serif; color: #444;">
                                Distribución del número de recamaras para las propiedades en diferentes segmentos (S, A,
                            ...
                            <ul
                                ...
                                <li>Si una barra es baja, indica que hay menos propiedades con ese número de recámaras.
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div style="text-align: left;">
                            <ul
                                ...
                                <li><strong>General:</strong> La mayoría de las propiedades presentan 3 recámaras
                                    <strong>(56.2%)</strong>, lo que representa la parte más significativa del mercado.
                                    Le siguen las
                                    propiedades con 2 recámaras <strong>(27%)</strong> , que también son comunes en la
                                    región. Por otro
                                    lado, las propiedades con 1 sola recámara <strong>(1.1%)</strong> son menos comunes
                                    en comparación
                                    con aquellas con dos o tres recámaras.
                                </li>
                                <li><strong>Segmentos:</strong> Las propiedades con <strong>3 recámaras</strong> son las
            ...
            <div class="row align-items-center"
                ...
                -->
                    ...
                    <div
                        ...
                        <div style="text-align: left;">
                            <p style="font-size: 16px; font-family: 'Arial', sans-serif; color: #444;">
                                Distribución del número de baños para las propiedades en diferentes segmentos (S, A, B,
                                C, D, E). Conoce un panorama claro sobre los rangos de baños predominantes y menos
                                predominantes.
                            </p>
                            <ul
                                style="font-size: 16px; font-family: 'Arial', sans-serif; color: #444; list-style-type: disc; padding-left: 20px;">
                                <li>Si una barra es alta, significa que hay muchas propiedades con ese número de baños
                                    dentro de ese rango en particular.</li>
                                <li>Si una barra es baja, indica que hay menos propiedades con ese número de baños en
                                    específico.
                                </li>
                            </ul>
                        </div>
                    ...
                    <div
                        ...
                        <div style="text-align: left;">
                            <ul
                                style="font-size: 16px; font-family: 'Arial', sans-serif; color: #666; list-style-type: disc; padding-left: 20px;">
                                <li>En el <strong>segmento S</strong>, la mayoría de las propiedades tienen <strong>2 y
                                        3 baños</strong>. Esto se puede
                                    observar en las barras altas en este segmento para las propiedades con estos números
                                    de baños.
                                </li>
                                ...
                                <li>El <strong>segmento B</strong> muestra una predominancia de propiedades con
                                    ...
                                    observar en la barra alta en este segmento para las propiedades, seguido de 3 baños.
                                </li>
                                <li>En los <strong>segmentos C y D</strong>, la mayoría de las propiedades es común
                                    encontrar entre <strong>3 y 2
                                        baños</strong>.</li>
                                <li>El <strong>segmento E</strong> tiene mayor propiedades en cada categoría de número
                                    de baños. En las
            ...
            <div class="row align-items-center"
                ...
                -->
                    ...
                    <div
                        ...
                        <div style="text-align: left;">
                            <p style="font-size: 16px; font-family: 'Arial', sans-serif; color: #444;">
                                Distribución del número de estacionamientos para las propiedades en diferentes segmentos
                                (S, A, B, C, D, E). Observa como se distribuyen los números de lugares de
                                estacionamiento para comprender las preferencias del mercado en cuanto a este aspecto.
                            </p>
                            <ul
                                style="font-size: 16px; font-family: 'Arial', sans-serif; color: #444; list-style-type: disc; padding-left: 20px;">
                                <li>Si una barra es alta, significa que hay muchas propiedades con esa cantidad de
                                    estacionamientos</li>
                                <li>Si una barra es baja, indica que hay menos propiedades con esa cantidad de espacios
                    ...
                    <div
                        ...
                        <div style="text-align: left;">
                            <ul
                                style="font-size: 16px; font-family: 'Arial', sans-serif; color: #666; list-style-type: disc; padding-left: 20px;">
                                <li>Los <strong>segmentos S, A, B, C, D</strong> muestran una preferencia marcada por
                                    <strong>1 estacionamiento</strong>.
                                    Esto se puede observar en las barras altas en estos segmentos para las propiedades
                                    con estos números de estacionamientos.</li>
                                <li>El <strong>segmento D</strong> tiene una notable cantidad de propiedades con 1 estacionamiento.</li>
                                <li>El <strong>segmento E</strong> destaca con propiedades con 1 estacionamiento seguido de 2. Esto se
